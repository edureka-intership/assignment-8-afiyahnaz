...
function SearchPageResult() {
  ...
  let   getLocationList  = async  () =>{
    try{
        let response = await   axios.get(
          // "https://zomatoclonenodejs.herokuapp.com/api/getLocation"
          "http://localhost:5003/api/getLocation"
          );
  ...
  let filterOperation = async (filter) => {
    let URL = 
    // "https://zomatoclonenodejs.herokuapp.com/api/filter";
    "http://localhost:5003/api/filter";
    try {
